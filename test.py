...
def main(dataset_path, batch_size, max_len, image_size, model_path):
    ...
    test_loss, test_accuracy, test_precision, test_recall, test_f1 = evaluate(model, criterion, test_loader)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test a trained ViViT model on a dataset")
